...
class Fireball(object):
    def __init__(self, x_pos, y_pos, move_direction: bool):
        ...
        self.image_tick = 0
        self.images = [pg.image.load(f'{current_dir}/images/fireball.png').convert_alpha()]
        ...
        self.images.append(pg.image.load(f'{current_dir}/images/firework0.png').convert_alpha())
        self.images.append(pg.image.load(f'{current_dir}/images/firework1.png').convert_alpha())
        self.images.append(pg.image.load(f'{current_dir}/images/firework2.png').convert_alpha())
