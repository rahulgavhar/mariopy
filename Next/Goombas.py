...
class Goombas(Entity):
    def __init__(self, x_pos, y_pos, move_direction):
        ...
        self.images = [
            pg.image.load(f'{current_dir}/images/goombas_0.png').convert_alpha(),
            pg.image.load(f'{current_dir}/images/goombas_1.png').convert_alpha(),
            pg.image.load(f'{current_dir}/images/goombas_dead.png').convert_alpha()
        ]
