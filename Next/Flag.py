...
class Flag(object):
    def __init__(self, x_pos, y_pos):
        ...
        self.pillar_image = pg.image.load(f'{current_dir}/images/flag_pillar.png').convert_alpha()
        self.pillar_rect = pg.Rect(x_pos + 8, y_pos, 16, 304)

        self.flag_image = pg.image.load(f'{current_dir}/images/flag.png').convert_alpha()
